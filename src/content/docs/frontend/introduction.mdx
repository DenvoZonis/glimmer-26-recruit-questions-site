---
title: Web前端简介
description: 微光工作室2026招新——Web前端简介
...
> 由于AI的影响，各行业发展都变得不景气，互联网行业也深受影响，从这几年沙软的毕业生走向可以简单地进行分析，越来越多的学长学姐选择出国或保研，选择直接就业的人变少了，大厂offer很难拿到。

从我们大前端方向来看，不少学长都感叹：‘前端还是好找工作啊’。

什么前端工作会好找呢？我认为主要原因有两个：
...
如果有什么不懂的，可以试试下面的途径去寻找问题的答案：

- 浏览器
- [CSDN](https://www.csdn.net/)
- [博客园 - 开发者的网上家园 (cnblogs.com)](https://www.cnblogs.com/)
- [前端 - 掘金 (juejin.cn)](https://juejin.cn/frontend)
- [SegmentFault 思否](https://segmentfault.com/)
- ChatGPT等模型

> 当然如果你在学习过程中有什么疑问，也可以向微光群友们或者每道题的出题人求助哦。