---
title: 1：环境搭建
description: 微光工作室2026招新——后端：1：环境搭建

prev:
  link: /recruit/archives/25/backend/introduction/
  label: 后端简介
next:
...
>这是一段Java代码，作用是在屏幕上打印“Hello World”，那么如何运行这段代码呢？
>
>请先在本地创建⼀个空⽂件"HelloJava.java"（不要更改文件名）把代码复制进去，完成下列任务并回答相应问题。
