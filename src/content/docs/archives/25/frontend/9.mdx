...
- **[本题文件点此下载](/recruit/archives/frontend/useDrawing.zip)**  
...
import T9_2 from '../../../../../assets/archives/frontend/9-1.png';

<Image src={T9_2} alt="9-1" />

（还可以追求更多功能，参考下面的在线画布网站：）

import T9 from '../../../../../assets/archives/frontend/9-2.png';

<Image src={T9} alt="9-2" />
