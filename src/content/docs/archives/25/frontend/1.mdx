...
prev:
  link: /recruit/archives/25/frontend/introduction/
  label: 前端简介
next:
...
import F12 from '../../../../../assets/archives/frontend/1-1.png';

   <Image src={F12} alt="DevTools" />
...
1. 链接：<Badge text="<a>" /> 指向你喜欢的网站
2. 图片：<Badge text="<img>" /> 展示一些你喜欢的图片！
