...
1. **Transformer的特点**是什么？主要解决什么问题？优缺点又是什么？
...
1. **RoPE vs 正弦位置编码**
   ...
   - 扩展阅读：2026年主流大模型（如GPT-5）常用RoPE（旋转位置编码），因为它外推性更好。有兴趣的同学可自行查阅，本题不强制要求实现
...
当你跑通这个MiniGPT，看到AI开始蹦出“莎士比亚式”的单词时，恭喜你！你已经掌握了现代AI 80%的底层密码。
至于2026年大火的Hyperloop、稀疏注意力、Keel千层架构……它们都是在你刚敲完的这几百行代码上演进出来的。打好地基，未来的摩天大楼任你建造！
