---
title: 5：IO流与项目挑战
description: 微光工作室2026招新——Web后端：5：IO流与项目挑战
...
> 恭喜你，JavaSE 的学习已近尾声！这一节你将掌握 IO 流操作、初识 Maven 项目管理，并结合网络基础知识，完成一个从客户端到服务端的完整小项目，迈出实战第一步。继续加油，未来的后端大手子！(･∞･ﾐэ )Э
>
...
[点击下载图片](/backend/doro.zip)

请你将这张可爱的doro复制到你的项目根目录下，命名为doro.jpg
...
### 恭喜你~你已经对maven有初步的了解了！现在，向着项目挑战进发吧！=͟͟͞͞=͟͟͞͞=͟͟͞͞=͟͟͞͞)🎒)˃̶͈̀ω˂̶͈́ )੭ 
